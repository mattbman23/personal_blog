...
I will be using [Oracle Cloud](https://www.oracle.com/cloud/sign-in.html) as they provide a compute instance for life.
...
To ssh into your compute instance once it's up. You first need to change to permission of your private key by running the `sudo chmod 400 <>` you can ssh into it by running the command `ssh opc@<your compute public ip address> -i <your downloaded private key>`
...
### Configuring domain and accessing portainer locally
